...
public class CustomerIntegration {
    ...
    private final ICustomerProvisionRestClient customerProvisionRestClient;
    private final EurekaDiscoveryClient        eurekaDiscoveryClient;


    @Retry(name = "customer-provision")
    public String addCustomer(Customer customerParam){
        return customerProvisionRestClient.add(customerParam);
    }
    ...
    public Customer findCustomerWithFeignClient(String phoneNumber) {
